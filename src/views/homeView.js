...
import { btnsFunctions } from "../functions/buttons"
      ...
      <main class="flex-1 p bg-slate-100 min-h-screen">
        ...
        ${
          user?.role === "admin"
            ? `
              <section
                class="bg-white p-5 rounded-lg shadow mb-6" id="navcito"
              >
                ...
                <button
                  class="mt-3 bg-blue-600 text-white px-4 py-2 rounded" id="btnCreate" data-id="${user?.id}"
                >
                  Crear reserva
                </button>
        ...
        ${
          ...
          <h2>Editar Sala</h2>
          <div>
            <label>ingrese la nueva sala</label>
            <input 
            type="text"
              id="newSala"
              name="title"
          ...
          <div>
            ...
            type="time"
              id="newTime"
              requedir><p>horario de finalizacion</p><input type="time" id="endTime" requedir>
          </div>
          <div>
            <label>Motivo:</label>
            <input 
          ...
          <div>
            ...
            >
              ...
              <option value="support">rejected</option>
          </select>
          </div>
          <button type="submit">
            Save Changes
